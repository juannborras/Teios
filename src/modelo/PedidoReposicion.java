...
public final class PedidoReposicion implements IIdentificable<String> {
     ...
     */
    public void marcarEnviado(LocalDate fechaEnvio) {
     ...
     */
    public void marcarRecibido(LocalDate fechaRecepcion) {
    ...
    public static PedidoReposicion reconstruir(String id,
                                                Proveedor proveedor,
        ...
        // sobrescribimos los campos según lo que viene de la BD
        // OJO: el constructor ya pone fechaCreacion = now, pero acá la corregimos
        // si querés ser más prolijo, podrías tener un constructor privado que reciba todo.
        pedido.estado = estado;
        // usamos reflexión de nuestro propio campo final solo si querés ser estricto,
        // pero en tu TPO basta con aceptar que fechaCreacion de reconstrucción puede ser now,
        // o cambiar el campo para que no sea final.
        // Para hacerlo sencillo aquí:
        // - dejá fechaCreacion tal como está si no te importa la diferencia de fecha histórica
        pedido.fechaEnvio = fechaEnvio;
        pedido.fechaRecepcion = fechaRecepcion;
